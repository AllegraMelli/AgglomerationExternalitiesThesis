...
if __name__ == "__main__":
    ...
    model = VensimModel("JacobsModel", wd=wd, model_file=r'RECOVERED_Simple model Opposing views.vpmx')
...
RealParameter('Relative share women in fertile age', 0.4, 0.6)]
    ...
    save_results(results, "./sobol scenario run Opposing views Jacobs.tar.gz")
