...
if __name__ == "__main__":
    ...
    model = VensimModel("MARModel", wd=wd, model_file=r'MAR region France_improved Struggling Synergies.vpmx')
...
RealParameter('Relatedness[Manufacturing of communication equipment,Telecommunication]', 0.8, 1)   
    ...
    save_results(results, "./sobol scenario run Struggling Synergies MAR.tar.gz")
