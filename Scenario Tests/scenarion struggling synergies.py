...
if __name__ == "__main__":
    ...
    model = VensimModel("JacobsModel", wd=wd, model_file=r'RECOVERED_Simple model Struggling Synergies.vpmx')
...
RealParameter('Relative share women in fertile age', 0.4, 0.6)]
    ...
    save_results(results, "./sobol scenario run Struggling Synergies Jacobs.tar.gz")
